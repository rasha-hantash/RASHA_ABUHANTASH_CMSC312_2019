    ...
    public void run() {
        ...
        while (Clock.cycle > 0) {
            while (readyQueue.size() != 0 || Clock.waitingQueue.size() != 0) {
               ...
               lock.lock();
                // GUI.text.setText("" + Clock.clockCycle);
                String criticalSection = "" + Clock.runProcess.pcb.entered_crit;
                if(Clock.readyQueue.size() >=1){
                    GUI.readyProcess1.setText( Clock.readyQueue.get(0).pcb.processID 
                    + "\t\t" + Clock.readyQueue.get(0).pcb.memory 
                    + " \t\t\t " + Clock.readyQueue.get(0).processStates.toString()
                    + " \t\t\t " + "FALSE");
                } else {
                ...
                if(Clock.readyQueue.size()>=2){
                    GUI.readyProcess2.setText( Clock.readyQueue.get(1).pcb.processID 
                    + "\t\t" + Clock.readyQueue.get(1).pcb.memory 
                ...
                if(Clock.readyQueue.size()>=3){
                    GUI.readyProcess3.setText( Clock.readyQueue.get(2).pcb.processID 
                    + "\t\t" + Clock.readyQueue.get(2).pcb.memory 
                ...
                if(Clock.readyQueue.size()>=4){
                    GUI.readyProcess4.setText( Clock.readyQueue.get(3).pcb.processID 
                    + "\t\t" + Clock.readyQueue.get(3).pcb.memory 
                ...
                if(Clock.readyQueue.size()>=5){
                    GUI.readyProcess5.setText( Clock.readyQueue.get(4).pcb.processID 
                    + "\t\t" + Clock.readyQueue.get(4).pcb.memory 
                ...
                if(Clock.readyQueue.size()>=6){
                    GUI.readyProcess6.setText( Clock.readyQueue.get(5).pcb.processID 
                    + "\t\t" + Clock.readyQueue.get(5).pcb.memory 
                ...
                if(Clock.readyQueue.size()>=7){
                    GUI.readyProcess7.setText( Clock.readyQueue.get(6).pcb.processID 
                    + "\t\t" + Clock.readyQueue.get(6).pcb.memory 
                ...
                if(Clock.readyQueue.size()>=8){
                    GUI.readyProcess8.setText( Clock.readyQueue.get(7).pcb.processID 
                    + "\t\t" + Clock.readyQueue.get(7).pcb.memory 
                ...
                if(Clock.readyQueue.size()>=9){
                    GUI.readyProcess9.setText( Clock.readyQueue.get(8).pcb.processID 
                    + "\t\t" + Clock.readyQueue.get(8).pcb.memory 
                ...
                if(Clock.readyQueue.size()>=10){
                    GUI.readyProcess10.setText( Clock.readyQueue.get(9).pcb.processID 
                    + "\t\t" + Clock.readyQueue.get(9).pcb.memory 
                ...
                if(Clock.waitingQueue.size() >=1){
                    ...
                    + "\t\t" + Clock.waitingQueue.get(0).pcb.memory 
                ...
                if(Clock.waitingQueue.size()>=2){
                    ...
                    + "\t\t" + Clock.waitingQueue.get(1).pcb.memory 
                ...
                if(Clock.waitingQueue.size()>=3){
                    ...
                    + "\t\t" + Clock.waitingQueue.get(2).pcb.memory 
                ...
                if(Clock.waitingQueue.size()>=4){
                    ...
                    + "\t\t" + Clock.waitingQueue.get(3).pcb.memory 
                ...
                if(Clock.waitingQueue.size()>=5){
                    ...
                    + "\t\t" + Clock.waitingQueue.get(4).pcb.memory 
                ...
                if(Clock.waitingQueue.size()>=6){
                    ...
                    + "\t\t" + Clock.waitingQueue.get(5).pcb.memory 
                ...
                if(Clock.waitingQueue.size()>=7){
                    ...
                    + "\t\t" + Clock.waitingQueue.get(6).pcb.memory 
                ...
                if(Clock.waitingQueue.size()>=8){
                    ...
                    + "\t\t" + Clock.waitingQueue.get(7).pcb.memory 
                ...
                if(Clock.waitingQueue.size()>=9){
                    ...
                    + "\t\t" + Clock.waitingQueue.get(8).pcb.memory 
                ...
                if(Clock.waitingQueue.size()>=10){
                    ...
                    + "\t\t" + Clock.waitingQueue.get(9).pcb.memory 
            ...
            Clock.cycle--;
            if(Clock.cycle > 0){
                Clock.fileReader(Clock.processRequest[0], "OS/src/main/java/cmsc312/programfile0.txt");
                Clock.fileReader(Clock.processRequest[1], "OS/src/main/java/cmsc312/programfile1.txt");
                Clock.fileReader(Clock.processRequest[2], "OS/src/main/java/cmsc312/programfile2.txt");
                Clock.fileReader(Clock.processRequest[3], "OS/src/main/java/cmsc312/programfile3.txt");
                Clock.fileReader(Clock.processRequest[4], "OS/src/main/java/cmsc312/programfile4.txt");
            }
